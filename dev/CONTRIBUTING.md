# Contributing to glydb

This outlines how to propose a change to glydb. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("glycoverse/glydb", fork = TRUE)`.
...
Please note that the glydb project is released with a [Contributor Code
of Conduct](https://glycoverse.github.io/glydb/dev/CODE_OF_CONDUCT.md).
